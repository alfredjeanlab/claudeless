...
- **Hook Protocol**: All 10 events (pre tool use, post tool use, post tool use failure, notification, permission request, session start, session end, prompt submit, pre-compaction, stop)
