...
#[test]
#[ignore] // autocomplete shows only exact/fuzzy name matches; real Claude also shows related commands
...
#[test]
#[ignore] // autocomplete shows only exact/fuzzy name matches; real Claude also shows related commands + missing /remote-env
...
fn capsh_setup_01_select_theme_dark() {
    // Setup wizard content exceeds 24 rows; use taller terminal so ratatui
    // doesn't clip the top (real Claude scrolls the terminal).
    specs::run_capsh_spec_with_size(
        "v2.1.29",
