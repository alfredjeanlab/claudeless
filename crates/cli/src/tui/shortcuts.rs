...
pub static SHORTCUTS: &[Shortcut] = &[
    ...
    Shortcut { keys: "shift + tab to auto-accept", column: 1 },
    Shortcut { keys: "edits", column: 1 }, // continuation of "shift + tab to auto-accept edits"
    Shortcut { keys: "ctrl + o for verbose output", column: 1 },
    Shortcut { keys: "ctrl + t to show todos", column: 1 },
    Shortcut { keys: "shift + \u{23ce} for newline", column: 1 },
    // Right column
    Shortcut { keys: "ctrl + shift + - to", column: 2 },
    Shortcut { keys: "undo", column: 2 }, // continuation of "ctrl + shift + - to undo"
    Shortcut { keys: "ctrl + z to suspend", column: 2 },
    Shortcut { keys: "ctrl + v to paste", column: 2 },
    Shortcut { keys: "images", column: 2 }, // continuation of "ctrl + v to paste images"
    Shortcut { keys: "meta + p to switch", column: 2 },
    Shortcut { keys: "model", column: 2 }, // continuation of "meta + p to switch model"
    Shortcut { keys: "ctrl + s to stash", column: 2 },
    Shortcut { keys: "prompt", column: 2 }, // continuation of "ctrl + s to stash prompt"
    Shortcut { keys: "ctrl + g to edit in", column: 2 },
    Shortcut { keys: "$EDITOR", column: 2 }, // continuation of "ctrl + g to edit in $EDITOR"
    Shortcut { keys: "/keybindings to", column: 2 },
    Shortcut { keys: "customize", column: 2 }, // continuation of "/keybindings to customize"
];
