...
fn resolves_claude_prefixed_aliases() {
    assert_eq!(resolve_model_id("claude-haiku"), "claude-haiku-4-5-20251001");
    assert_eq!(resolve_model_id("claude-sonnet"), "claude-sonnet-4-20250514");
    assert_eq!(resolve_model_id("claude-opus"), "claude-opus-4-5-20251101");
}

#[test]
fn passes_through_full_ids() {
    assert_eq!(resolve_model_id("claude-haiku-4-5-20251001"), "claude-haiku-4-5-20251001");
    assert_eq!(resolve_model_id("claude-opus-4-5-20251101"), "claude-opus-4-5-20251101");
}
