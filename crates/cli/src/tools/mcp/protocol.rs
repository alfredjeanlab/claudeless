...
impl JsonRpcRequest {
    ...
    pub fn initialize(id: u64, params: McpInitializeParams) -> Self {
        Self::new(
            id,
            "initialize",
    ...
    pub fn tools_call(id: u64, params: McpToolCallParams) -> Self {
        Self::new(
            id,
            "tools/call",
            Some(serde_json::to_value(params).unwrap()),
...
mod tests {
    ...
    fn test_initialize_request() {
        let req = JsonRpcRequest::initialize(1, McpInitializeParams::default());
    ...
    fn test_tools_call_request() {
        let params =
            McpToolCallParams::new("read_file", Some(serde_json::json!({ "path": "/tmp" })));
        let req = JsonRpcRequest::tools_call(3, params);
